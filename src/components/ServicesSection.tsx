        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {services.map((service, i) => {
            ...
            return (
              <div
                key={i}
                className="group p-6 rounded-xl border border-slate-100 border-l-4 border-l-teal-400 bg-white hover:bg-teal-50/50 shadow-sm hover:shadow-md transition-all"
              >
